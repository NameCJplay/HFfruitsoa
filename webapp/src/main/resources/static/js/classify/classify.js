...
function addthis(classifyId) {
	layer.open({
		...
		area : [ '800px', '300px' ],
		content : '/ClassifyAddThis?classifyId='+classifyId
	});
}
function add() {
	layer.open({
...
function edit(id) {
	layer.open({
		...
		shadeClose : false, // 点击遮罩关闭层
		area : [ '800px', '320px' ],
		content : '/ClassifyEdit?classifyId=' + id // iframe的url
	});
}
function remove(id) {
